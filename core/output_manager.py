...
class OutputManager:
    ...
    def print_row_summary(self, context):
        ...
        print("\n--- GAUSSIAN MODELING ---")
        print(f"PRICE GAUSSIAN PROB: {self._get(statistics, 'price_gaussian_prob')}")
        print(f"GAUSSIAN ZONE: {self._get(statistics, 'gaussian_zone')}")
        print(f"GAUSSIAN TAIL: {self._get(statistics, 'gaussian_tail')}")
        print(f"GAUSSIAN EXTREME: {self._get(statistics, 'gaussian_extreme')}")
        print(f"GAUSSIAN CONFIDENCE: {self._get(statistics, 'gaussian_confidence')}")

        print("\n--- EXTREME EVENT DETECTION ---")
        print(f"PRICE EXTREME EVENT: {self._get(statistics, 'price_extreme_event')}")
        print(f"VOLUME EXTREME EVENT: {self._get(statistics, 'volume_extreme_event')}")
        print(f"DELTA EXTREME EVENT: {self._get(statistics, 'delta_extreme_event')}")
        print(f"VELOCITY EXTREME EVENT: {self._get(statistics, 'velocity_extreme_event')}")
        print(f"GAUSSIAN EXTREME EVENT: {self._get(statistics, 'gaussian_extreme_event')}")
        print(f"SPREAD EXTREME EVENT: {self._get(statistics, 'spread_extreme_event')}")
        print(f"GLOBAL EXTREME EVENT: {self._get(statistics, 'global_extreme_event')}")
        print(f"EXTREME EVENT SCORE: {self._get(statistics, 'extreme_event_score')}")
        print(f"EXTREME EVENT STATE: {self._get(statistics, 'extreme_event_state')}")
        print(f"EXTREME EVENT CONTEXT: {self._get(statistics, 'extreme_event_context')}")
        print(f"EXTREME EVENT ORIGIN: {self._get(statistics, 'extreme_event_origin')}")
